    ...
    const AgentStep& step) const
{
    ...
    auto forces = DrivingForce(model, step.to_next_target());
...
Point SocialForceModel::DrivingForce(const State& self, Point to_next_target)
{
    const Point e0 = to_next_target.Normalized();
