...
void init_python_model(py::module_& m)
{
    py::class_<OperationalModel, py::smart_holder>(m, "OperationalModel")
        .def(
            "compute_next_state",
            [](const OperationalModel& self, OperationalModelStateVariant state, py::object step) {
                ...
                return std::make_tuple(
                    static_cast<const OperationalModelStateVariant&>(next),
