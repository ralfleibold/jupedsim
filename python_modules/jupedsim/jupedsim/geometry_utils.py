...
def _polygon_from_wkt(wkt_input: str) -> py_jps.FlatSurface:
...
def build_polygon(
    ...
    **kwargs: Any,
    ...
    """Create a :class:`~jupedsim.native.FlatSurface` from different input representations.
...
def as_wkt(surface: py_jps.FlatSurface) -> str:
    """Converts a FlatSurface into a wkt

    Returns:
        String: wkt
    """
    poly = shapely.Polygon(surface.boundary(), holes=surface.holes())
